...
1. ### What are Data-types in JavaScript
   ...
   A data type in a language defines the type of data a variable can hold. Javascript is a dynamically typed language(you don't have to specify what type of information will be store in a variable in advance) scripting language that is in the javascript variable scan receive different data type over time. Data type are typed data that can be used and manipulated in a program.
